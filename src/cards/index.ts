...
// on first turn
import registerSummoningSickness from '../modifiers/modifierSummoningSickness';
import registerCorpseDecay from '../modifiers/modifierCorpseDecay';
import registerImmune, * as immune from './immune';
import registerImpendingDoom from '../modifiers/modifierImpendingDoom';
import registerSoulShardOwner from '../modifiers/modifierSoulShardOwner';
import registerUndying from '../modifiers/modifierUndying';
...
import registerPrimedCorpse from '../modifiers/modifierPrimedCorpse';
import registerSlime from '../modifiers/modifierSlime';
import registerUnstable from '../modifiers/modifierUnstable';
import registerCurseImmunity from '../modifiers/modifierCurseImmunity';
import registerDoubleDamage from '../modifiers/modifierDoubleDamage';
import registerConfidence from '../modifiers/modifierConfidence';
import registerDefiance from '../modifiers/modifierDefiance';
import registerDamageLimiter from '../modifiers/modifierDamageLimiter';
import registerTargetImmune, { targetImmuneId } from '../modifiers/modifierTargetImmune';
import registerGrowth from '../modifiers/modifierGrowth';
import registerModifierStatUpgrades from '../modifiers/modifierStatUpgrades';
import registerReroll from '../modifiers/modifierReroll';
import registerDareDevil from '../modifiers/modifierDareDevil';
import registerEndlessQuiver from '../modifiers/modifierEndlessQuiver';
import registerInexhaustible from '../modifiers/modifierInexhaustible';
import registerAffinityBlessing from '../modifiers/modifierAffinityBlessing';
import registerAffinityCurse from '../modifiers/modifierAffinityCurse';
import registerAffinityDamage from '../modifiers/modifierAffinityDamage';
import registerAffinityMovement from '../modifiers/modifierAffinityMovement';
import registerAffinitySoul from '../modifiers/modifierAffinitySoul';
import registerAffinityTargeting from '../modifiers/modifierAffinityTargeting';
import registerFarGazerRune from '../modifiers/modifierFarGazer';
import registerGamblerRune from '../modifiers/modifierGambler';
import registerAlchemist from '../modifiers/modifierAlchemist';
import registerGolemancer from '../modifiers/modifierGolemancer';
import registerNecromancerRune from '../modifiers/modifierNecromancer';
import registerTimemasonRune from '../modifiers/modifierTimemason';
import registerWitchRune from '../modifiers/modifierWitch';
import registerArmor from '../modifiers/modifierArmor';
import registerHealthRegen from '../modifiers/modifierHealthRegen';
import registerManaBarrier from '../modifiers/modifierManaBarrier';
import registerOnHitHealing from '../modifiers/modifierOnHitHealing';
import registerOnHitPoison from '../modifiers/modifierOnHitPoison';
import registerOverheal from '../modifiers/modifierOverheal';
import registerRevitalize from '../modifiers/modifierRevitalize';
import registerSelfInvulnerability from '../modifiers/modifierSelfImmunity';
import registerShieldRegen from '../modifiers/modifierShieldRegen';
import registerThorns from '../modifiers/modifierThorns';
import registerBasePierce from '../modifiers/modifierBasePierce';
import registerBaseRadiusBoost from '../modifiers/modifierBaseRadiusBoost';
import registerContaminateSelfOnTeleport from '../modifiers/modifierContaminateSelfOnTeleport';
import registerCloneOnSpawn from '../modifiers/modifierCloneOnSpawn';
import registerCloneOnTeleport from '../modifiers/modifierCloneOnTeleport';
import registerGoodLooking from '../modifiers/modifierGoodLooking';
import registerShieldBash from '../modifiers/modifierShieldBash';
import registerOnKillMana from '../modifiers/modifierOnKillMana';
import registerBounty from '../modifiers/modifierBounty';
import registerMoreBounties from '../modifiers/modifierBountyMore';
import registerBountyHunter from '../modifiers/modifierBountyHunter';
import registerBountyRefresh from '../modifiers/modifierBountyRefresh';
import registerBountyRestoreStamina from '../modifiers/modifierBountyRestoreStamina';
import registerBountyDamage from '../modifiers/modifierBountyDamage';
import registerBountySuffocate from '../modifiers/modifierBountySuffocate';
import registerBountyPotion from '../modifiers/modifierBountyPotion';
import registerBountyPortal from '../modifiers/modifierBountyPortal';
import registerBountyGolem from '../modifiers/modifierBountyGolem';
import registerLiquidmancer from '../modifiers/modifierLiquidmancer';
import registerHeavyImpacts from '../modifiers/modifierHeavyImpact';
import registerSecretIngredients from '../modifiers/modifierSecretIngredients';
import registerPotionEffectiveness from '../modifiers/modifierPotionEffectiveness';
import registerPotionBarrier from '../modifiers/modifierPotionBarrier';
import registerCreepingDeath from '../modifiers/modifierCreepingDeath';
import registerPlagueBringer from '../modifiers/modifierPlagueBringer';
import registerHeavyToxins from '../modifiers/modifierHeavyToxins';
import registerOnKillResurrect from '../modifiers/modifierOnKillResurrect';
import registerMeleeSpecialist from '../modifiers/modifierMeleeSpecialist';
import registerBlackCoin from '../modifiers/modifierBlackCoin';
import registerLastStand from '../modifiers/modifierLastStand';
import registerContaminateOnKill from '../modifiers/modifierContaminateOnKill';
import registerHatOfDespair from '../modifiers/modifierHatOfDespair';
import registerTownPortal from '../modifiers/modifierTownPortal';
import registerBloodLetting from '../modifiers/modifierBloodLetting';
import registerInvestment from '../modifiers/modifierInvestment';
import registerWintersChill from '../modifiers/modifierWintersChill';
import registerIcyVeins from '../modifiers/modifierIcyVeins';
import registerBloodWarlock from '../modifiers/modifierBloodWarlock';
import registerWitchBane from '../modifiers/modifierWitchBane';
import registerThornyDecoys from '../modifiers/modifierThornyDecoys';
import registerSharpTeeth from '../modifiers/modifierSharpTeeth';
import registerHardenedMinions from '../modifiers/modifierHardenedMinions';
import registerReflex from '../modifiers/modifierReflex';
import registerPlagueDoctor from '../modifiers/modifierPlagueDoctor';
import registerWhirlpool from '../modifiers/modifierWhirlpool';
import registerPrecision from '../modifiers/modifierPrecision';
...
export function registerCards(overworld: Overworld) {
  ...
  registerSlime();
  registerUnstable();
  registerCurseImmunity();
  registerDoubleDamage();
  registerConfidence();
  registerDefiance();
